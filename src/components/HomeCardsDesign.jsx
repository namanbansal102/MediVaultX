    ...
    <div   data-aos="slide-right" className="max-w-7xl mx-auto px-4 py-16 bg-white">
      <div className="space-y-4 mb-12">
        ...
        <p className="text-xl text-gray-600">
          Find resources that will help you navigate, use, and build on BOT Chain Mainnet.
        </p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {[
          {
            title: "Governance",
            description: "Use BOT Chain Mainnet to manage secure healthcare records.",
            icon: (
          ...
          {
            title: "Explorer",
            description: "Find transactions and review activity on BOT Chain Mainnet.",
            icon: (
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {
            title: "Faucet",
            description: "Use BOT tokens to build and test healthcare dApps.",
            icon: (
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
